    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/ayan-chattopadhyay-663a2228a" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Ayan Chattopadhyay</b>
                </a>
            </p>
            """, unsafe_allow_html=True)
     ...
     "124852522.jpg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <h2 class="profile-name">Ayan Chattopadhyay</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/Ayan03092005" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/ayan-chattopadhyay-663a2228a" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:ayanchattopadhyay05@gmail.com" class="social-link" target="_blank">
